...
```{r simulation}
a<-rnorm(n = 50, mean = 30, sd =2) ### change these numbers, change these terms to something meaningful!
b<-rnorm(50, 20, 4)
c<-rnorm(50, 40, 4)   ## i changed the numbers to be more in line with what id expect with my perception data, large mean values (cuz we're measuring distances and large SDs)
